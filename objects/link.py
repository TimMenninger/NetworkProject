...
class Link:
	...
	def __init__(self, the_link_name, the_capacity, the_delay, the_buffer, 
		...
		# Buffers which will contain (time, flow_name, packet_name) pairs which
		#	describe the packets queuing to be sent.
		self.buffers = ([],[])
		
		# Keep track of the amount of data in each buffer.
		self.buffer_current_load = (0, 0)
		
		# IDs of Packet currently on the link
		self.packets_carrying = []
		
		# Amount of data on link
		self.link_current_load = 0
